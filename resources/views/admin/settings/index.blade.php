            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label text-end">الشحن مجاني عند شراء بسعر</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="main_title" type="number" value="{{$setting['main_title']}}" id="example-text-input">
                                            </div>
                                        </div>
                                        </div>
                                        </div>
                   ...
                   <div class="form-group mb-3 row">
                          ...
                          <hr>
                          <div class="mb-1 row">
                                            <h3>سياسة الخصوصية باللغة الانجليزية</h3>
                                            <div class="col-sm-12"> 
                                            <textarea  id="textareaen" name="section1_details_en" rows="10" >{{$setting['section1_details_en']}}</textarea>                                      
                                           </div>
                                        </div>
                          <hr>
                                        <div class="mb-1 row">
                                        ...
                                        <div class="mb-1 row">
                                            <h3>الشحن والاستلام باللغة الانجليزية</h3>
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="textarea1_en" name="section2_details_en" rows="5" >{{$setting['section2_details_en']}}</textarea>                                      
                                           </div>
                                        </div>                          <hr>
                                       <div class="mb-1 row">
                                        ...
                                        <div class="mb-1 row">
                                            <h3>     سياسة الاسترجاع باللغة الانجليزية</h3>
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="textarea2_en" name="section3_details_en" rows="5" >{{$setting['section3_details_en']}}</textarea>                                      
                                           </div>
                                        </div>                          <hr>
                                        <div class="mb-1 row">
                                        ...
                                        <div class="mb-1 row">
                                            <h3> الاسئلة الشائعة باللغة الانجليزية</h3>
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="textarea3en" name="section4_details_en" rows="5" >{{$setting['section4_details_en']}}</textarea>                                      
                                           </div>
                                        </div>                          <hr>
                                    ...
                                    @csrf 
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="mb-1 row">
                                            <h6>   العنوان ومعلومات التواصل</h6>
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="textarea6" name="address" rows="5" >{{$setting['address']}}</textarea>                                      
                                           </div>
                                        </div>                          <hr>
                                        <div class="mb-1 row">
                                            <h6>   العنوان ومعلومات التواصل</h6>
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="textarea6en" name="addressen" rows="5" >{{$setting['addressen']}}</textarea>                                      
                                           </div>
                                        </div>                          <hr>
...
<!--<script src="https://cdn.tiny.cloud/1/2yd8ex62k92msjoitswpr30ehq2593t264d1ymj1refsitis/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>-->
     ...
     <script>
                 ...
                 <script>
                        ...
                        CKEDITOR.replace( 'textarea1_en' );
                </script>
                 <script>
                        CKEDITOR.replace( 'textarea2' );
                        CKEDITOR.replace( 'textarea2_en' );
                </script>
                 <script>
                        CKEDITOR.replace( 'textarea3' );
                        CKEDITOR.replace( 'textarea3en' );
                </script>
                 <script>
                        CKEDITOR.replace( 'textarea4' );
                        CKEDITOR.replace( 'textarea4_en' );
                </script>
                 <script>
                        CKEDITOR.replace( 'textarea6' );
                        CKEDITOR.replace( 'textarea6en' );
                </script>
...
<!--<script>tinymce.init({selector:'#textarea6'});</script>-->
