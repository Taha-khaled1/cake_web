                                                ...
                                                <ul class="list-unstyled list mb-0">
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="{{ url('/') }}/cp/assets/images/xs/avatar1.svg" alt="">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="{{ url('/') }}/cp/assets/images/xs/avatar3.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="{{ url('/') }}/cp/assets/images/xs/avatar5.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="{{ url('/') }}/cp/assets/images/xs/avatar6.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="{{ url('/') }}/cp/assets/images/xs/avatar7.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                    ...
                                    <div class="card border-0 w280">
                                        <div class="card-body pb-0">
                                            <div class="d-flex py-1">
                                                <img class="avatar rounded-circle" src="{{ url('/') }}/cp/assets/images/profile_av.svg" alt="profile">
                                                <div class="flex-fill ms-3">
                                                    <p class="mb-0"><span class="font-weight-bold">Admin	Admin</span></p>
                                                    <small class="">Admin@Admin.com</small>
                                                </div>
                                            </div>
                                        ...
                                        <form method="POST" action="{{ route('logout') }}" class="btn btn-log-out flex-fill">
                                            ...
                                            <a href="{{route('logout')}}" class="btn"
                                               ...
                                               this.closest('form').submit();"class="list-group-item list-group-item-action border-0 "><i class="icofont-logout fs-5 me-3"></i> 
                                                تسجيل خروج </a>
                                            </form>
