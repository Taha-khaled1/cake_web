                                ...
                                <div class="tab-content">
                                    <div class="tab-pane p-3 active" id="Post" role="tabpanel">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <input class="form-check-input" value="1" name="featured" type="checkbox"  checked >
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <input class="form-control" id="namee" name="name" type="text" value="{{old('name')}}" id="example-text-input"  maxlength="100">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                       ...
                                       <div class="col-sm-9">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <small class="form-text text-danger">{{$message}}</small>
                                            @enderror
                                                <input class="form-control" name="price" type="text" id="price"  maxlength="100" value="{{old('price')}}" >
                                            </div>
                                        </div>
