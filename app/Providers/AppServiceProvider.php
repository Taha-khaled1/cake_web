...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('layouts.layoutSite.Footer', function ($view) {
            ...
            $addressen = $setting->where('key', 'addressen')->first()->value;
        ...
        // });
            ...
            $view->with('header_logo',$header_logo)
            ->with('phone',$phone)
            ->with('address',$address)
            ->with('addressen',$addressen)
            ->with('email',$email)
        ...
        view()->composer('layouts.admin.menu', function ($view) {
            ...
            $view->with('header_logo',$header_logo) ;  // this is line 22 
        });
