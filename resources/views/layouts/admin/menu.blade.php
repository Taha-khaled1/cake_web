                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-pro" href="#">
                            <i class="icofont-paper fs-5"></i> <span>التقارير الماليه</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                            <!-- Menu: Sub menu ul -->
                    ...
                    <li><a class="m-link" href="{{route('admin.carousels')}}"><i class="icofont-file-bmp fs-5"></i> <span>  عروض الصفحة الرئيسية</span></a></li>
                    <li><a class="m-link" href="{{route('admin.contact')}}"><i class="icofont-file-bmp fs-5"></i> <span>  التواصل معنا</span></a></li>
